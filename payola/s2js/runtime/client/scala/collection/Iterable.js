s2js.runtime.client.core.get().classLoader.provide('scala.collection.Iterable');
...
s2js.runtime.client.core.get().classLoader.require('scala.NotImplementedException');
...
s2js.runtime.client.core.get().classLoader.require('scala.math');
...
scala.collection.Iterable.prototype.$minus$minus$eq = function(coll) {
var self = this;
coll.foreach(function($x$2) {
self.$minus$eq($x$2);
});
};
...
if (self.isEmpty()) {
(function() {
throw new scala.UnsupportedOperationException('empty.reduceLeft', undefined);
})();
}
...
if (self.isEmpty()) {
(function() {
throw new scala.UnsupportedOperationException('empty.reduceRight', undefined);
})();
}
...
if (self.isEmpty()) {
(function() {
throw new scala.UnsupportedOperationException('empty.min', undefined);
})();
}
...
if (self.isEmpty()) {
(function() {
throw new scala.UnsupportedOperationException('empty.max', undefined);
})();
}
...
if (self.isEmpty()) {
(function() {
throw new scala.UnsupportedOperationException('empty.maxBy', undefined);
})();
}
...
if (self.isEmpty()) {
(function() {
throw new scala.UnsupportedOperationException('empty.minBy', undefined);
})();
}
...
var separator = '';
var suffix = '';
if (s2js.runtime.client.core.get().isDefined(end)) {
result = start;
separator = sep;
suffix = end;

} else {
if (s2js.runtime.client.core.get().isDefined(sep)) {
result = start;
separator = start;

} else {
if (s2js.runtime.client.core.get().isDefined(start)) {
separator = start;
}
...
scala.collection.Iterable.prototype.$minus$minus = function(that) {
var self = this;
var b = self.newInstance();
b.$plus$plus$eq(self);
b.$minus$minus$eq(that);
return b;
...
var self = this;
return self.filter(function($x$3) {
return (! p($x$3));
});
};
...
var self = this;
return (function() {
throw new scala.NotImplementedException('Function collect is not implemented.', undefined);
})();
};
...
var self = this;
return (! self.forall(function($x$4) {
return (! p($x$4));
}));
};
scala.collection.Iterable.prototype.find = function(p) {
var self = this;
var result = scala.None.get();
scala.util.control.Breaks.get().breakable(function() {
self.foreach(function(x) {
if (p(x)) {
...
var result = function() {
return (function() {
throw new scala.NoSuchElementException('empty.head', undefined);
})();
};
scala.util.control.Breaks.get().breakable(function() {
self.foreach(function(x) {
...
if (self.isEmpty()) {
(function() {
throw new scala.UnsupportedOperationException('empty.tail', undefined);
})();
}
...
if (self.isEmpty()) {
(function() {
throw new scala.UnsupportedOperationException('empty.init', undefined);
})();
}
...
scala.collection.Iterable.prototype.takeRight = function(n) {
var self = this;
...
var self = this;
return self.sliceWithKnownBound(scala.math.get().max(from, 0), until);
};
...
var self = this;
var clazz = s2js.runtime.client.core.get().classOf(self);
return (function() {
if ((clazz != null)) {
...
scala.collection.Iterable.prototype.__class__ = new s2js.runtime.client.core.Class('scala.collection.Iterable', []);
